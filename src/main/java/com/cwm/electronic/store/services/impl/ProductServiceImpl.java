...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDto update(ProductDto productDto, String productId) {
        ...
        Product product = productRepository.findById(productId).orElseThrow(() -> new ResourceNotFoundExveption("product not found wiht given id"));
    ...
    public ProductDto createWithCategory(ProductDto productDto, String categoryId) {
        ...
        //fetch the category
        Category category = categoryRepository.findById(categoryId).orElseThrow(() -> new ResourceNotFoundExveption("category not found !!"));
        Product product = mapper.map(productDto, Product.class);
        //prd id
        String s = UUID.randomUUID().toString();
        product.setProductId(s);
    ...
    public ProductDto updateCategory(String productId, String categoryId) {
        ...
        //product fetch
        Product product = productRepository.findById(productId).orElseThrow(() -> new ResourceNotFoundExveption("product of given id not found !!"));
        Category category = categoryRepository.findById(categoryId).orElseThrow(() -> new ResourceNotFoundExveption("category of given id not found"));
        product.setCategory(category);
