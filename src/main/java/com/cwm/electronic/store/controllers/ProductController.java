...
import com.cwm.electronic.store.dtos.*;
...
public class ProductController {
    ...
    public ResponseEntity<ImageResponse> uploadProductImage(
        ...
        ImageResponse response = ImageResponse.builder().imageName(updatedProduct.getProductImageName()).message(" product image success uploaded !!").status(HttpStatus.CREATED).success(true).build();
